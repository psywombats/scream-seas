...
speak('leo', "And besides, maybe you're safer in here with me than out there. Ari's never liked me, but since Shawn vanished, she's been... strange.")
speak('leo', "Look, it's not like Cy or I or even Shawn could operate the radio equipment. That weird signal is either Ari, or something unnatural. And I think Ari's convinced that a human set it up, because she's the human that set it up.")
clear()
...
speak('leo', "And Cy, well... When she stares up into the stars, I wonder how many eyes are gazing back at her? They say the souls of the dead watch from the heavens...")
