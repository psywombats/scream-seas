...
speak('leo', "That guy? Deader than Kelsey's nuts, poor bastard. It seems Sleeping Beauty here is the only survivor. That is, if they ever up.")
...
speak('ari', "No, but...")
speak('leo', "I'll figure out something, but for now, don't go smothering them in their sleep. But I need to be on the bridge. Keep an eye on Sleeping Beauty for me alright?")
exit('leo')
