...
enter('ari', 'd')
speak('leo', "You!")
speak('ari', "Oh, the kid. Who exactly are you supposed to be?")
speak('ari', "Psh. I suppose I already know.")
speak('leo', "No! Mare Deo! Kid, you traitor! You betrayed us to Mare -")
exitNVL()
...
wait(1.5)
beginMessage()
message("THINE TASK IS COMPLETE, MY SERVANT")
wait(2)
