...
wait(2)
speak('cy', "Sorry, but... It'll be here soon.")
exitNVL()
cyPan()
await()
enterNVL()
speak('cy', "There's not much hope, is there? Shawn was the only real engineer here. There's been some damage already, and with a crew this small... But I don't think that's really a storm out there. Maybe Ari's right, or Leo's lying, but I think Shawn somehow knew that Mare Deo was on the way.")
