...
speak('you', "...")
exit('you')
speak('leo', "I've made my decision. We can't afford a delay in the schedule by turning around now. If we want to be in the green for this month, we can drop off the kid when we're at port. So for the next six days, you're a guest on the Revolution. Welcome, kid.")
speak('shawn', "Here here!")
...
speak('cy', "Leo, they have a right to know what's going on. If we were doing this properly, we would've turned the kid over to the coast guard ships. This is like we're keeping them hostage.")
